...
# Form implementation generated from reading ui file 'daa_project.ui'
#
...
class Ui_MainWindow(object):
    ...
    def daa_project(self, n):
        ...
        if n < 0:
            ...
            crore_output = for_tens_ones(self, crore) + " crore "

            lakh_output = for_tens_ones(self, lakh) + " lakh "

            thousand_output = for_tens_ones(self, thousand) + " thousand "

            hundred_output = for_tens_ones(self, hundred) + " hundred "

            tens_ones_output = for_tens_ones(self, tens_ones)
            ...
            if hundred > 0:
                output4 = hundred_output

            if tens_ones > 0:
                output5 = tens_ones_output

            output = output1 + output2 + output3 + output4 + output5 + " only "
        return output

    def calculate_clicked(self):
        self.n = int(self.lineEdit_3.text())
        output = self.daa_project(self.n)
